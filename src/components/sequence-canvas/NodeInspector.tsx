          ...
          <>
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground mt-1.5">
                {(cfg.mode ?? "ai") === "ai"
                  ? "Subject and body are generated in TWO separate AI calls using the node's configured model — your subject prompt only controls the subject, your body prompt only controls the body."
              ...
              <>
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground mt-1">
                    This prompt runs as its own AI call and only outputs the subject line. Use {`{{variables}}`} to personalize.
                  </p>
                </div>
                <div>
                  ...
                  />
                  <p className="text-[11px] text-muted-foreground mt-1">
                    This prompt runs as its own AI call and only outputs the email body. Sign-off and footer are added automatically.
                  </p>
                </div>
